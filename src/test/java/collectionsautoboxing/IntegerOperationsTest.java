...
public class IntegerOperationsTest {
    ...
    public void checkElementTypeInList() {
        ...
        System.out.println("Createlist, input int, output Integer: " + numbers);
    }
    ...
    public void checkSumValueInList() {
        ...
        System.out.println("sumIntegerList, input Integer, output int: " + abox.createList(2, 4, 6));
    }

    @Test
    public void sumIntegerObjects() {
        assertEquals(12, new IntegerOperations().sumIntegerObjects(2, 4, 6));
        System.out.println(new IntegerOperations().sumIntegerObjects(2, 4, 6));
    }
}